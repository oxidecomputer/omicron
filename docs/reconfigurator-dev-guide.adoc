...
You can copy that file around as needed and then import it into `reconfigurator-cli`:
...
+
```
$ tufaceous build --fake --system-version 1.0.0 -o /var/tmp/my-fake-repo.zip
```
