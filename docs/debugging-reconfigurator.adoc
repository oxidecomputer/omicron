...
* Some time after the update started, the customer experienced a new, unacceptable problems (e.g., instances lost network connectivity).
...
Other components have on-disk file formats as well.
