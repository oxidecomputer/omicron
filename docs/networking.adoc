...
We'll discuss these in more detail later.  There are also many other kinds of links and commands to listing specific types.  See the manual page for more details.
...
Finally, you can use the portable `ifconfig` tool to list much of the same information.  We'll be sticking to the illumos tools.
