...
**VNICs** are virtual NICs created _over_ some other link.  These behaves as though each VNIC were plugged into the same network as that other link.  For example, suppose we create three VNICs over `cxgbe0`.  This logically looks like this:
