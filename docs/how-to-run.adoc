...
If you're running on a Gimlet, you don't need (or want) most of what `cargo xtask virtual-hardware create` does, but you do still need SoftNPU.  You'll have to look at the script and run that part by hand.
