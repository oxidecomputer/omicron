...
Ensure the system's blueprint planner is disabled. The live tests will generate various blueprints with potentially-questiable content, and we don't want the planner to run mid-test and attempt to "fix" the state of the system.
