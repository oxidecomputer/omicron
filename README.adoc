...
...
listening: http://192.168.1.123:12220
----
...
[source,text]
----
$ cargo run --bin=sled-agent-sim -- $(uuidgen) 127.0.0.1:12345 [fd00:1234::7]:12221
...
...
++ curl -sSi http://192.168.1.123:12220/organizations -X POST -T - -H 'oxide-authn-spoof: 001de000-05e4-0000-0000-000000004007'
++ json -ga
...
++ curl -sSi http://192.168.1.123:12220/organizations/myorg/projects -X POST -T -
++ json -ga
HTTP/1.1 100 Continue
...
++ curl -sSi http://192.168.1.123:12220/organizations/myorg/projects/myproject/instances -X POST -T -
++ json -ga
HTTP/1.1 100 Continue
...
++ curl -sSi http://192.168.1.123:12220/organizations/myorg/projects/myproject/instances/myinstance
++ json -ga
HTTP/1.1 200 OK
content-type: application/json
...
++ curl -sSi http://192.168.1.123:12220/organizations/myorg/projects/myproject/disks -X POST -T -
++ json -ga
HTTP/1.1 100 Continue
...
++ curl -sSi http://192.168.1.123:12220/organizations/myorg/projects/myproject/disks/mydisk
++ json -ga
HTTP/1.1 200 OK
content-type: application/json
...
++ curl -sSi http://192.168.1.123:12220/organizations/myorg/projects/myproject/instances/myinstance/disks
