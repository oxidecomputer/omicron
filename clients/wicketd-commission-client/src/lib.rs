...
progenitor::generate_api!(
    ...
    replace = {
        ...
        BootstrapSledState = wicketd_commission_types_versions::latest::inventory::BootstrapSledState,
        ...
        GetUpdateProgressResponse = wicketd_commission_types_versions::latest::update::GetUpdateProgressResponse,
        IgnitionControllerDetect = wicketd_commission_types_versions::latest::inventory::IgnitionControllerDetect,
        ...
        LaneMonitors = wicketd_commission_types_versions::latest::inventory::LaneMonitors,
        ...
        RackOperation = wicketd_commission_types_versions::latest::rack_setup::RackOperation,
        RackOperationState = wicketd_commission_types_versions::latest::rack_setup::RackOperationState,
        RackSetupStatus = wicketd_commission_types_versions::latest::rack_setup::RackSetupStatus,
        RackState = wicketd_commission_types_versions::latest::rack_setup::RackState,
        ...
        RunRackSetupResponse = wicketd_commission_types_versions::latest::rack_setup::RunRackSetupResponse,
