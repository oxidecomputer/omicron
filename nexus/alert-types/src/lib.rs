...
pub trait AsAlert: Serialize + JsonSchema + fmt::Debug {
    fn class(&self) -> AlertClass;
    fn version(&self) -> u32;
}
...
impl Probe {
    pub const CLASS: AlertClass = AlertClass::Probe;
    pub const VERSION: u32 = 0;
}

impl AsAlert for Probe {
    fn class(&self) -> AlertClass {
        Self::CLASS
    }
    fn version(&self) -> u32 {
