...
api_versions!([
    ...
    (2026_06_01_00, ADDITIONAL_BGP_CONFIGURATION_OPTIONS),
...
pub trait NexusExternalApi {
    ...
    #[endpoint {
        ...
        tags = ["system/networking"],
        versions = VERSION_ADDITIONAL_BGP_CONFIGURATION_OPTIONS..,
    }]
    ...
    #[endpoint {
        ...
        path = "/v1/system/networking/switch-port-settings",
        tags = ["system/networking"],
        versions = VERSION_REMOVE_DUPLICATED_NETWORKING_TYPES..VERSION_ADDITIONAL_BGP_CONFIGURATION_OPTIONS,
    }]
