...
//! Nexus external types that changed from 2026010300 to 2026010400.
//!
//! Version 2026010300 (DUAL_STACK_NICS) uses `Vec<NameOrId>` for multicast_groups
//! in InstanceCreate. Version 2026010400 uses `Vec<MulticastGroupJoinSpec>`.
