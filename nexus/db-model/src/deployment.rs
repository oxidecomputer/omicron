...
use crate::{
    ByteCount, DbOximeterReadMode, Generation, MacAddr, Name, SledState, SqlU8,
    SqlU16, SqlU32, impl_enum_type, ipv6,
};
...
use nexus_types::deployment::{BlueprintDatasetConfig, OximeterReadMode};
