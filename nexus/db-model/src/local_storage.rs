...
#[derive(Queryable, Insertable, Debug, Clone, Selectable, PartialEq)]
#[diesel(table_name = rendezvous_local_storage_unencrypted_dataset)]
pub struct RendezvousLocalStorageUnencryptedDataset {
    id: DbTypedUuid<DatasetKind>,
...
impl RendezvousLocalStorageUnencryptedDataset {
    pub fn new(
        id: DatasetUuid,
        pool_id: ZpoolUuid,
        blueprint_id_when_created: BlueprintUuid,
