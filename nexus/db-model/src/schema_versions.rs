...
pub const SCHEMA_VERSION: SemverVersion = SemverVersion::new(47, 0, 0);
...
static KNOWN_VERSIONS: Lazy<Vec<KnownVersion>> = Lazy::new(|| {
    vec![
        ...
        KnownVersion::new(47, "migration-conflict-demo-2"),
        KnownVersion::new(46, "migration-conflict-demo-1"),
