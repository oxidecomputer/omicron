...
pub const SCHEMA_VERSION: Version = Version::new(301, 0, 0);
...
pub static KNOWN_VERSIONS: LazyLock<Vec<KnownVersion>> = LazyLock::new(|| {
    vec![
        ...
        KnownVersion::new(301, "control-plane-router-list-default"),
        KnownVersion::new(300, "router-configuration-bgp-src-addr"),
        KnownVersion::new(299, "router-configurations"),
