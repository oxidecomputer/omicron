...
pub const SCHEMA_VERSION: Version = Version::new(306, 0, 0);
...
pub static KNOWN_VERSIONS: LazyLock<Vec<KnownVersion>> = LazyLock::new(|| {
    vec![
        ...
        KnownVersion::new(306, "federation-authentication"),
        KnownVersion::new(305, "federation-session"),
        KnownVersion::new(304, "federation-trust-policy"),
        KnownVersion::new(303, "federation-identity-provider"),
        ...
        KnownVersion::new(266, "alert-version"),
        KnownVersion::new(265, "sled-resource-vmm-state"),
