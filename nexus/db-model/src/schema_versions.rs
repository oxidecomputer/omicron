...
pub const SCHEMA_VERSION: Version = Version::new(296, 0, 0);
...
pub static KNOWN_VERSIONS: LazyLock<Vec<KnownVersion>> = LazyLock::new(|| {
    vec![
        ...
        KnownVersion::new(296, "multicast-member-parent-kind"),
        KnownVersion::new(295, "multicast-member-origin"),
        KnownVersion::new(294, "drop-multicast-deleted-state"),
