...
pub const SCHEMA_VERSION: Version = Version::new(305, 0, 0);
...
pub static KNOWN_VERSIONS: LazyLock<Vec<KnownVersion>> = LazyLock::new(|| {
    vec![
        ...
        KnownVersion::new(305, "federation-authentication"),
        KnownVersion::new(304, "federation-session"),
        KnownVersion::new(303, "federation-trust-policy"),
        KnownVersion::new(302, "federation-identity-provider"),
