...
use crate::external_api::networking;
...
pub(crate) fn external_api() -> NexusApiDescription {
    fn register_endpoints(api: &mut NexusApiDescription) -> Result<(), String> {
        ...
        api.register(networking::networking_switch_port_settings_view)?;
        api.register(networking::networking_switch_port_settings_create)?;
        api.register(networking::networking_switch_port_settings_delete)?;

        api.register(networking::networking_switch_port_list)?;
        api.register(networking::networking_switch_port_apply_settings)?;
        api.register(networking::networking_switch_port_clear_settings)?;
