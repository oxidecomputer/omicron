...
use sled_agent_types::{
    early_networking::BfdPeerConfig,
    system_networking::BlueprintExternalNetworkingConfig,
};
        ...
        async move {
            ...
            for rack in &racks {
                ...
                for (switch_slot, port, change) in &changes {
                    ...
                    // Build the bootstore BGP peers from the switch port
                        ...
                        info
                            ...
                            .map(|peer| {
                                ...
                                SledBgpPeerConfig {
                                    ...
                                    idle_hold_time: Some(
                                        peer.idle_hold_time.into(),
                                    ),
                                    delay_open: Some(peer.delay_open.into()),
                                    connect_retry: Some(
                                        peer.connect_retry.into(),
                                    ),
