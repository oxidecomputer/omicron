...
use crate::db::schema::{
    ...
    service, snapshot, ssh_key, update_available_artifact, user_builtin, volume,
...
#[derive(Copy, Clone, Debug, AsExpression, FromSqlRow, Serialize, Deserialize, Eq, Ord, PartialEq, PartialOrd)]
