...
/// [`crate::context::OpContext::authorize()`].
///
/// Aside from Organizations and Sleds, all instances of all types of Fleet
/// children are treated interchangeably by the authz subsystem.  That's because
/// we do not currently support assigning roles to these resources, so all that
...
use db_macros::authz_resource; // XXX-dap
...
//
//impl Sled {
//    pub fn new(_: Fleet, sled_id: Uuid, lookup_type: LookupType) -> Sled {
...
//     ) -> ProjectChild {
//         ProjectChild {
//             parent: ProjectChildKind::Direct(parent),
//             resource_type,
//             resource_id,
//             lookup_type,
//         }
...
//     ) -> ProjectChild {
//         ProjectChild {
//             parent: ProjectChildKind::Indirect(Box::new(parent)),
//             resource_type,
//             resource_id,
//             lookup_type,
//         }
