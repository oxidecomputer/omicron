...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct FederationSessionList;

pub const FEDERATION_SESSION_LIST: FederationSessionList =
    FederationSessionList {};

impl oso::PolarClass for FederationSessionList {
    fn get_polar_class_builder() -> oso::ClassBuilder<Self> {
        oso::Class::builder()
            .with_equality_check()
            .add_method(
                "has_role",
                |_: &FederationSessionList,
                 _actor: AuthenticatedActor,
                 _role: String| false,
            )
            .add_attribute_getter("fleet", |_| FLEET)
...
impl AuthorizedResource for FederationSessionList {
    fn load_roles<'fut>(
        &'fut self,
        opctx: &'fut OpContext,
        authn: &'fut authn::Context,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct SiloFederationIdentityProviderList(Silo);

impl SiloFederationIdentityProviderList {
    pub fn new(silo: Silo) -> SiloFederationIdentityProviderList {
        SiloFederationIdentityProviderList(silo)
    }
...
impl oso::PolarClass for SiloFederationIdentityProviderList {
    fn get_polar_class_builder() -> oso::ClassBuilder<Self> {
        oso::Class::builder().with_equality_check().add_attribute_getter(
            "silo",
            |list: &SiloFederationIdentityProviderList| list.0.clone(),
        )
    }
}

impl AuthorizedResource for SiloFederationIdentityProviderList {
    fn load_roles<'fut>(
        &'fut self,
        opctx: &'fut OpContext,
        authn: &'fut authn::Context,
