        ...
        let artifacts = ArtifactSet::from([
            ...
            make_artifact(
                RotTags {
                    ...
                    rot_sign: RotSign(Some(ROT_SIGN_GIMLET.into())),
            ...
            make_artifact(
                RotTags {
                    rot_board: String::from("oxide-rot-1"),
                    rot_sign: RotSign(Some(ROT_SIGN_COSMO.into())),
                    rot_slot: tufaceous_artifact::RotSlot::A,
                }
                .into(),
            ...
            make_artifact(
                RotTags {
                    rot_board: String::from("oxide-rot-1"),
                    rot_sign: RotSign(Some(ROT_SIGN_PSC.into())),
                    rot_slot: tufaceous_artifact::RotSlot::A,
                }
                .into(),
            ...
            make_artifact(
                RotTags {
                    rot_board: String::from("oxide-rot-1"),
                    rot_sign: RotSign(Some(ROT_SIGN_SWITCH.into())),
                    rot_slot: tufaceous_artifact::RotSlot::A,
                }
                .into(),
