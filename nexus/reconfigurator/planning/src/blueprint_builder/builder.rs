...
use crate::planner::disks_editor::EditDatasetsError;
...
pub struct BlueprintBuilder<'a> {
    ...
    pub(crate) zones: BlueprintZonesBuilder<'a>,
...
impl<'a> BlueprintBuilder<'a> {
    ...
    pub fn build(
        ...
        let (blueprint_disks, blueprint_datasets) =
            disks_editor.build(self.input.all_sled_ids(SledFilter::InService));
...
impl<'a> BlueprintZonesBuilder<'a> {
    ...
    pub(crate) fn change_sled_zones(
        &mut self,
        sled_id: SledUuid,
...
pub mod test {
    ...
    use crate::planner::disks_editor::zone_name;
    ...
    fn test_basic() {
        ...
        let blueprint2 = builder.build(BlueprintDisksEditor::new(&blueprint1));
        ...
        let mut disks_editor = BlueprintDisksEditor::new(&blueprint2);
        disks_editor.sled_ensure_disks(new_sled_id, new_sled_resources);
        disks_editor
        ...
        let blueprint3 = builder.build(disks_editor);
    ...
    fn test_prune_decommissioned_sleds() {
        ...
        *blueprint1.sled_state.get_mut(&decommision_sled_id).unwrap() =
        ...
        .expect("created builder")
        .build(BlueprintDisksEditor::new(&blueprint2));
        verify_blueprint(&blueprint3);
    ...
    fn test_ensure_cockroachdb() {
        ...
        let mut disks_editor = BlueprintDisksEditor::new(&parent);
        disks_editor.sled_ensure_disks(target_sled_id, sled_resources);
        disks_editor
            .sled_ensure_datasets(
                target_sled_id,
                sled_resources,
