...
// See `Nexus::endpoint_for_request()`.  This is factored out to be able to test
// it without a whole server.
pub fn endpoint_for_authority(
    log: &slog::Logger,
...
#[cfg(test)]
mod test {
    use super::authority_for_request;
    use super::endpoint_for_authority;
    use super::ExternalEndpointError;
    use super::ExternalEndpoints;
    use super::NexusCertResolver;
