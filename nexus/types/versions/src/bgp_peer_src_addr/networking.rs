...
/// The peer address for a BGP session, supporting both numbered and unnumbered
/// peers. For numbered peers, an optional source address can be specified to
/// control the local IP used when establishing the session.
#[derive(
    Clone, Copy, Debug, Deserialize, Serialize, JsonSchema, PartialEq, Eq, Hash,
)]
#[serde(tag = "type", rename_all = "snake_case")]
pub enum RouterPeerType {
    /// A numbered BGP peer, identified by a routable IP address.
    Numbered {
        /// IP address for numbered BGP peers.
        ip: RouterPeerIpAddr,
        /// Optional source IP address for the BGP session. When set, mgd will
        /// bind to this address when establishing the TCP connection to the
        /// peer.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        src_addr: Option<RouterPeerIpAddr>,
    },
    /// An unnumbered BGP peer, identified by the interface it is reachable on.
    Unnumbered {
...
impl RouterPeerType {
    /// Returns `true` if this is a numbered (addressed) peer.
    pub fn is_numbered(&self) -> bool {
        matches!(self, Self::Numbered { .. })
    }

    /// Returns `true` if this is an unnumbered peer.
    pub fn is_unnumbered(&self) -> bool {
        matches!(self, Self::Unnumbered { .. })
    }
}

impl From<sled_agent_types_versions::v30::early_networking::RouterPeerType>
    for RouterPeerType
{
    fn from(
        value: sled_agent_types_versions::v30::early_networking::RouterPeerType,
    ) -> Self {
        match value {
            sled_agent_types_versions::v30::early_networking::RouterPeerType::Numbered { ip } => {
                Self::Numbered { ip, src_addr: None }
            }
            sled_agent_types_versions::v30::early_networking::RouterPeerType::Unnumbered { router_lifetime } => {
...
impl From<RouterPeerType>
    for sled_agent_types_versions::v30::early_networking::RouterPeerType
{
...
pub struct BgpPeer {
    ...
    /// The address of the host to peer with, or specifying the configuration
    /// of an unnumbered BGP session.
...
pub struct SwitchPortSettings {
    ...
    pub groups:
        Vec<crate::v2025_11_20_00::networking::SwitchPortSettingsGroups>,

    /// Layer 1 physical port settings.
    pub port: crate::v2025_11_20_00::networking::SwitchPortConfig,

    /// Layer 2 link settings.
    pub links: Vec<crate::v2025_11_20_00::networking::SwitchPortLinkConfig>,
...
/// Downgrade to `v2026_05_07_00::networking::SwitchPortSettings` by stripping
/// `src_addr` from BGP peers.
...
/// Direct downgrade to `v2026_04_16_00::networking::SwitchPortSettings` for
/// the `_v2026_04_16_00` view endpoint.
impl From<SwitchPortSettings>
    for crate::v2026_04_16_00::networking::SwitchPortSettings
{
    fn from(value: SwitchPortSettings) -> Self {
        crate::v2026_05_07_00::networking::SwitchPortSettings::from(value)
            .into()
    }
}
