...
// These conversion impls live here instead of `crate::impls` because they're
// required for the Serialize/Deserialize derivations or the other From/TryFrom
// impls in this module.
impl From<UplinkIpNet> for LoopbackAddressIpNet {
    fn from(value: UplinkIpNet) -> Self {
        Self(value)
    }
}

impl From<LoopbackAddressIpNet> for UplinkIpNet {
    fn from(value: LoopbackAddressIpNet) -> Self {
        value.0
    }
}

impl TryFrom<IpNet> for LoopbackAddressIpNet {
    type Error = UplinkIpNetError;
...
impl From<SwitchPortSettings>
    for v2026_05_07_00::networking::SwitchPortSettings
{
