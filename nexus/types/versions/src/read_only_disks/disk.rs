...
// -- Conversions from the previous version (INSTANCES_EXTERNAL_SUBNETS) --

impl From<crate::v2026013000::disk::DiskBackend> for DiskBackend {
    fn from(old: crate::v2026013000::disk::DiskBackend) -> Self {
        match old {
            crate::v2026013000::disk::DiskBackend::Local {} => Self::Local {},
            crate::v2026013000::disk::DiskBackend::Distributed {
                disk_source,
            } => {
                ...
                let disk_source = match disk_source {
                    ...
                    crate::v2025112000::disk::DiskSource::Image {
                        image_id,
...
impl From<crate::v2026013000::disk::DiskCreate> for DiskCreate {
    fn from(old: crate::v2026013000::disk::DiskCreate) -> Self {
        Self {
