...
//! Instance types for version INSTANCES_EXTERNAL_SUBNETS.
...
impl From<crate::v2025120300::instance::InstanceDiskAttachment>
    for InstanceDiskAttachment
{
    fn from(old: crate::v2025120300::instance::InstanceDiskAttachment) -> Self {
        match old {
            crate::v2025120300::instance::InstanceDiskAttachment::Create(
                create,
            ) => Self::Create(create.into()),
            crate::v2025120300::instance::InstanceDiskAttachment::Attach(
                attach,
            ) => Self::Attach(attach),
        }
    }
...
impl From<crate::v2026010500::instance::InstanceCreate> for InstanceCreate {
    fn from(old: crate::v2026010500::instance::InstanceCreate) -> Self {
        Self {
