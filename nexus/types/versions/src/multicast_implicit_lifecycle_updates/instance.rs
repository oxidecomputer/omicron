...
//!
//! This version changes multicast groups from `Vec<NameOrId>` to
//! `Vec<MulticastGroupJoinSpec>`. It is also the earliest version where
//! `InstanceCreate` uses `MulticastGroupJoinSpec`, so `InstanceCreate` and
...
impl From<crate::v2025_11_20_00::instance::InstanceUpdate> for InstanceUpdate {
    fn from(old: crate::v2025_11_20_00::instance::InstanceUpdate) -> Self {
        Self {
            ncpus: old.ncpus,
            memory: old.memory,
...
pub enum InstanceDiskAttachment {
    ...
    Create(crate::v2025_12_03_00::disk::DiskCreate),
    /// During instance creation, attach this disk.
    Attach(InstanceDiskAttach),
}

impl From<crate::v2025_12_03_00::instance::InstanceDiskAttachment>
    for InstanceDiskAttachment
{
    fn from(
        old: crate::v2025_12_03_00::instance::InstanceDiskAttachment,
    ) -> Self {
        match old {
            crate::v2025_12_03_00::instance::InstanceDiskAttachment::Create(
                create,
            ) => Self::Create(create),
            crate::v2025_12_03_00::instance::InstanceDiskAttachment::Attach(
                attach,
            ) => Self::Attach(attach),
        }
    }
...
impl From<crate::v2026_01_05_00::instance::InstanceCreate> for InstanceCreate {
    fn from(old: crate::v2026_01_05_00::instance::InstanceCreate) -> Self {
        Self {
