  ...
  physical_provisioning_collection
    AS (
      ...
      SET
        ...
        cpus_provisioned = physical_provisioning_collection.cpus_provisioned + $16,
        ram_provisioned = physical_provisioning_collection.ram_provisioned + $17
      WHERE
