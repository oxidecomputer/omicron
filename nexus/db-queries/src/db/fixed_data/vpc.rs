...
lazy_static! {
    ...
    pub static ref SERVICES_VPC_ID: uuid::Uuid = "001de000-074c-4000-8000-000000000000"
        .parse()
        .expect("invalid uuid for builtin services vpc id");

    /// UUID of VpcRouter for built-in Services VPC.
    pub static ref SERVICES_VPC_ROUTER_ID: uuid::Uuid =
    ...
    pub static ref SERVICES_VPC_DEFAULT_ROUTE_ID: uuid::Uuid =
    ...
    pub static ref SERVICES_VPC: db::model::IncompleteVpc = db::model::IncompleteVpc::new(
        *SERVICES_VPC_ID,
