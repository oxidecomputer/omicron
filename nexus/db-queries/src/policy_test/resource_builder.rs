...
impl_dyn_authorized_resource_for_resource!(authz::WebhookEvent);
impl_dyn_authorized_resource_for_resource!(authz::WebhookReceiver);
...
impl_dyn_authorized_resource_for_global!(authz::WebhookEventClassList);
