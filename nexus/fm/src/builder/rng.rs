...
impl CaseBuilderRng {
    pub(super) fn new(
        ...
        let ereport_assignment_rng = TypedUuidRng::from_parent_rng(
            &mut sitrep.parent,
        ...
        let fact_rng = TypedUuidRng::from_parent_rng(
            &mut sitrep.parent,
            (case_id, "case-fact"),
        );
        Self { alert_rng, ereport_assignment_rng, support_bundle_rng, fact_rng }
    }
