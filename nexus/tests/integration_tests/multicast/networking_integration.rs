...
async fn test_multicast_with_external_ip_basic(
    ...
    let _ = test_setup_log("test_multicast_with_external_ip_basic");
...
async fn test_multicast_external_ip_lifecycle(
    ...
    let _ = test_setup_log("test_multicast_external_ip_lifecycle");
    let client = &cptestctx.external_client;
...
async fn test_multicast_with_external_ip_at_creation(
    ...
    let _ = test_setup_log("test_multicast_with_external_ip_at_creation");
    let client = &cptestctx.external_client;
...
async fn test_multicast_with_floating_ip_basic(
    ...
    let _ = test_setup_log("test_multicast_with_floating_ip_basic");
    let client = &cptestctx.external_client;
