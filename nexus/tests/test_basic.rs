...
async fn test_projects() {
    ...
    let new_project_ids = {
        ...
        for project_name in projects_to_create {
            let project_create = ProjectCreateParams {
                identity: IdentityMetadataCreateParams {
                    name: Name::try_from(project_name.to_string()).unwrap(),
     ...
     * requests.
     */
    let project_update = ProjectUpdateParams {
        identity: IdentityMetadataUpdateParams {
            name: None,
    ...
    let project_update = ProjectUpdateParams {
        identity: IdentityMetadataUpdateParams {
            name: Some(Name::try_from("lil-lightnin").unwrap()),
    ...
    let project_create = ProjectCreateParams {
        identity: IdentityMetadataCreateParams {
            name: Name::try_from("simproject1".to_string()).unwrap(),
    ...
    let project_create = ProjectCreateParams {
        identity: IdentityMetadataCreateParams {
            name: Name::try_from("honor-roller").unwrap(),
...
async fn test_projects_list() {
    ...
    for _ in 0..nprojects {
        ...
        let project =
            objects_post::<_, Project>(&client, &projects_url, create_params)
                .await;
