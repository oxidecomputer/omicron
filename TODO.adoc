...
*** fix commented-out test suite for Instances
*** Check for commented-out code in server_controller.rs
*** add integration test suite for disks
*** consider unit test suite for disks
*** See XXXs, new TODOs, unimplemented!(), todo!()
