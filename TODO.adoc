...
** done: create API endpoints to attach, detach
** done: refactor test_instances.rs
** self-review, including XXXs, new TODOs, unimplemented!(), todo!()
...
* implement disk delete (only allowed while detached?)
* RFD 24: regions, AZs, etc
* (lots more)

Work queue (see also: existing GitHub issues):

* make instance delete require that instance be stopped?
