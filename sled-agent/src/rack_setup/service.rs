...
// is done here, rather than with "impl From" at the defition, to avoid a
// dependency from omicron-common to dpd-client.  As dpd-client depends on
// omicron-common, that would create a circular dependency.
