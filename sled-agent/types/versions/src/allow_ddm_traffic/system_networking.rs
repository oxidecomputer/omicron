...
//!   [`super::early_networking::PortConfig`]s with the new
//!   `allow_ddm_traffic` field.
...
impl From<v47::system_networking::SystemNetworkingConfig>
    for SystemNetworkingConfig
{
    fn from(value: v47::system_networking::SystemNetworkingConfig) -> Self {
        Self {
...
impl From<SystemNetworkingConfig>
    for v47::system_networking::SystemNetworkingConfig
{
