...
//! Instance types for version `ROUTER_CONFIGS_IN_BOOTSTORE`.
...
use crate::v41;
use crate::v44;
use crate::v44::instance::VmmSpec;
...
pub struct InstanceSledLocalConfig {
    ...
    /// The tunnel router list to install on the instance's OPTE ports at
    /// creation. An empty list means no tunnel routers: the port is born
    /// closed and the router-lists background task corrects any drift.
    pub router_list: Vec<RouterListEntry>,
}

impl From<v44::instance::InstanceEnsureBody> for InstanceEnsureBody {
    fn from(old: v44::instance::InstanceEnsureBody) -> Self {
        Self {
