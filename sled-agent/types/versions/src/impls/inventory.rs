...
use crate::latest::inventory::{
    ...
    HostPhase2DesiredContents, HostPhase2DesiredSlots,
    MupdateOverrideBootInventory, MupdateOverrideInventory,
    MupdateOverrideNonBootInventory, OmicronSledConfig, OmicronZoneConfig,
    ...
    ZoneManifestBootInventory, ZoneManifestInventory,
...
impl ZoneManifestInventory {
    ...
    pub fn new_fake() -> ZoneManifestInventory {
...
impl ZoneManifestBootInventory {
    ...
    /// in `nexus-inventory`.
    pub fn new_fake() -> ZoneManifestBootInventory {
...
/// Display helper for [`ZoneManifestInventory`].
...
/// Display helper for [`ZoneManifestBootInventory`].
...
/// Display helper for [`ZoneManifestNonBootInventory`].
