...
use sled_agent_types_versions::{latest, v20, v26, v30, v33, v38};
...
impl EarlyNetworkConfigEnvelope {
    ...
    > {
        ...
        let f = versioned_decode!(
            ...
            v38::system_networking::SystemNetworkingConfig,
        );
...
from_body_for_envelope!(v38::system_networking::SystemNetworkingConfig);
