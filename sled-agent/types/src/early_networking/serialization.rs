...
use sled_agent_types_versions::{latest, v20, v26, v30, v33, v39, v42, v44};
...
impl EarlyNetworkConfigEnvelope {
    ...
    > {
        ...
        let f = versioned_decode!(
            ...
            v44::system_networking::SystemNetworkingConfig,
        );
...
from_body_for_envelope!(v44::system_networking::SystemNetworkingConfig);
