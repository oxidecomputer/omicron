...
use sled_agent_types_versions::{latest, v20, v26, v30, v33, v39, v41};
...
impl EarlyNetworkConfigEnvelope {
    ...
    > {
        ...
        let f = versioned_decode!(
            ...
            v41::system_networking::SystemNetworkingConfig,
        );
...
from_body_for_envelope!(v41::system_networking::SystemNetworkingConfig);
