...
use crate::{ArcIoError, ArcSerdeJsonError, ZoneImageZpools};
...
impl<T: PartialEq> InstallMetadataNonBootResult<T> {
    pub(crate) fn new(
        res: Result<Option<T>, InstallMetadataReadError>,
        boot_disk_res: &Result<Option<T>, InstallMetadataReadError>,
    ) -> Self {
