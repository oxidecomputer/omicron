...
/// `EarlyNetworkSetup` will be deleted soon as a part of
/// <https://github.com/oxidecomputer/omicron/issues/10167>.
///
/// It still exists to provide `lookup_uplinked_switch_zone_underlay_addrs()`,
/// which is used when sled-agent starts zones that require NAT entries. This
/// is only "early network" in the sense that it's part of the requirement for
/// cold booting; the name of this type is largely historical, where it
/// contained considerably more functionality to handle additional early rack
/// networking setup. We don't bother with a rename because we're going to
/// delete it soon anyway.
