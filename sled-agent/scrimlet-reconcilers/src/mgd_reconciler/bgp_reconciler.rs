...
pub struct MgdBgpReconcilerStatusOpCount {
    routers_deleted: usize,
    routers_updated: usize,
    routers_created: usize,

    origin4_deleted: usize,
    origin4_updated: usize,
    origin4_created: usize,

    origin6_deleted: usize,
    origin6_updated: usize,
    origin6_created: usize,

    shapers_deleted: usize,
    shapers_updated: usize,
    shapers_created: usize,

    checkers_deleted: usize,
    checkers_updated: usize,
    checkers_created: usize,

    numbered_peers_deleted: usize,
    numbered_peers_updated: usize,
    numbered_peers_created: usize,

    unnumbered_peers_deleted: usize,
    unnumbered_peers_updated: usize,
    unnumbered_peers_created: usize,
}
    ...
    fn serialize(
        ...
        match self {
            ...
            Self::Success { counts, did_change_max_paths } => {
                ...
                counts.serialize(record, serializer)
            }
