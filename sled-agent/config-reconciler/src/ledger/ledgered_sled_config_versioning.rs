...
version_conversion_chain!(
    v48::inventory::OmicronSledConfig,
...
pub(super) mod tests {
    ...
    const EXPECTORATE_V48_CONFIG_PATH: &str =
        "expectorate/v48-sled-config.json";
    ...
    async fn can_convert_v4_to_newer_versions() {
        ...
        let v48 = v48::inventory::OmicronSledConfig::from(v14.clone());
        ...
        expectorate::assert_contents(
            EXPECTORATE_V48_CONFIG_PATH,
            &serde_json::to_string_pretty(&v48).unwrap(),
        );
    ...
    async fn read_config_converts_from_older_versions() {
        ...
        // paths below.
        let latest_version_path = EXPECTORATE_V48_CONFIG_PATH;
        let expected_config = v48::inventory::OmicronSledConfig::read_from(
            log,
            latest_version_path.into(),
        )
        .await
        .expect("read v48 config");
