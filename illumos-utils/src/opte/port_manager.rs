...
fn omicron_to_opte_ip_config(
    ...
    let cfg = match (private_ips, external_ips) {
        (
            ...
            ExternalIpConfig::V4(external_v4),
        ...
        (
            ...
            ExternalIpConfig::V6(external_v6),
        ...
        (
            ...
            ExternalIpConfig::DualStack { v4: external_v4, v6: external_v6 },
        ) => {
        ...
        (PrivateIpConfig::V6(_), ExternalIpConfig::V4(_))
        | (PrivateIpConfig::V4(_), ExternalIpConfig::V6(_))
        | (
            PrivateIpConfig::V6(_) | PrivateIpConfig::V4(_),
            ExternalIpConfig::DualStack { .. },
...
mod tests {
    ...
    use omicron_common::api::internal::shared::ExternalIpsBuilder;
    use omicron_common::api::internal::shared::InternetGatewayRouterTarget;
    use omicron_common::api::internal::shared::NetworkInterface;
    use omicron_common::api::internal::shared::NetworkInterfaceKind;
    use omicron_common::api::internal::shared::PrivateIpConfig;
    ...
    fn multiple_ports_does_not_destroy_default_route() {
        ...
        let external_ip_config0 = ExternalIpsBuilder::new()
            .with_source_nat(
                SourceNatConfigV6::new(public_ipv4_addr0, 0, MAX_PORT).unwrap(),
            )
            .build()
            .unwrap()
            .into();
        ...
        let external_ip_config1 = ExternalIpsBuilder::new()
            .with_source_nat(
                SourceNatConfigV6::new(public_ipv4_addr1, 0, MAX_PORT).unwrap(),
            )
            .build()
            .unwrap()
            .into();
    ...
    fn ip_cfg_from_ipv4_params() {
        ...
        let source_nat =
            SourceNatConfigV6::new(IpAddr::V4(ext_ip), 0, 16383).unwrap();
        let external_ips = ExternalIpsBuilder::new()
    ...
    fn ip_cfg_from_ipv6_params() {
        ...
        let source_nat =
            SourceNatV6Config::new(IpAddr::V6(ext_ip), 0, 16383).unwrap();
        let external_ips = ExternalIpsBuilder::new()
            .with_source_nat(source_nat)
            .build()
            .unwrap()
    ...
    fn ip_cfg_from_dual_stack_params() {
        ...
        let external_ipv4 = ExternalIpsBuilder::new()
            .with_source_nat(source_nat)
            .build()
            .unwrap();
        let external_ipv6 = ExternalIpsBuilder::new()
            .with_ephemeral_ip(ext_ipv6)
            .build()
            .unwrap();
        let external_ips = ExternalIpConfig::DualStack {
            v4: external_ipv4,
            v6: external_ipv6,
        };
        let prs = PortCreateParams {
