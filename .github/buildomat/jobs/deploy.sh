...
pfexec zlogin oxz_switch /opt/oxide/omdb/bin/omdb db zpool list -i | \
    xargs -I{} -i pfexec zlogin oxz_switch /opt/oxide/omdb/bin/omdb -w db zpool set-storage-buffer "{}" 0
