...
function usage {
    ...
    echo
    echo "  -b COMMIT   Ask to update MGS to HEAD on the named branch."
    echo "  -c COMMIT   Ask to update MGS to a specific commit."
...
REPO="oxidecomputer/management-gateway-service"
