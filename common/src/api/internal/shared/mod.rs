...
/// address.
///
/// The underlay address must be within `UNDERLAY_MULTICAST_SUBNET`
/// (ff04::/64, a subset of admin-local scope per [RFC 7346]). This
/// invariant is enforced by mapping in Nexus, not validated at this layer.
///
