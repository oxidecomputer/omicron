...
//! Functional code for quantile estimation.

use crate::latest::histogram::HistogramSupport;
use crate::latest::quantile::FILLED_MARKER_LEN;
...
/// p-quantile.
#[derive(
    Debug, Clone, Error, PartialEq, JsonSchema, Serialize, Deserialize,
)]
