    ...
    fn to_block(items: &[Self]) -> Result<Block, Error> {
        ...
        Ok(Block {
            ...
            columns: IndexMap::from([
                ...
                (String::from("fields.type"), Column::from(ValueArray::Array {
                    inner_type: TYPE_ENUM_DATA_TYPE.clone(),
                    values: field_types
                })),
                (String::from("fields.source"), Column::from(ValueArray::Array {
                    inner_type: SOURCE_ENUM_DATA_TYPE.clone(),
                    values: field_sources
                })),
                (String::from("datum_type"), Column::from(ValueArray::Enum8 {
                    variants: DATUM_TYPE_ENUM_MAP.clone(),
                    values: datum_types
                })),
                (String::from("created"), Column::from(ValueArray::DateTime64 {
                    values: created,
