...
mod tests {
    ...
    fn test_mean_delta_value_in_window_omicron_8833() {
        let raw_data = &[
            ("2025-08-12T19:16:58.435139391Z", "2025-08-12T19:17:08.667092681Z", 17946389286f64),
            ("2025-08-12T19:17:08.667092681Z", "2025-08-12T19:17:08.671475687Z", 10642397f64),
            ("2025-08-12T19:17:08.671475687Z", "2025-08-12T19:17:18.672813543Z", 23427496526f64),
            ("2025-08-12T19:17:18.672813543Z", "2025-08-12T19:17:18.676645448Z", 9152142f64),
            ("2025-08-12T19:17:18.676645448Z", "2025-08-12T19:17:28.677720972Z", 23184788665f64),
            ("2025-08-12T19:17:28.677720972Z", "2025-08-12T19:17:28.680720Z",    6997216f64),
            ("2025-08-12T19:17:28.680720Z",    "2025-08-12T19:17:38.686374025Z", 23235718961f64),
            ("2025-08-12T19:17:38.686374025Z", "2025-08-12T19:17:38.690303163Z", 9409791f64),
            ("2025-08-12T19:17:38.690303163Z", "2025-08-12T19:17:48.692740660Z", 23351532686f64),
            ("2025-08-12T19:17:48.692740660Z", "2025-08-12T19:17:48.696535415Z", 9172642f64),
            ("2025-08-12T19:17:48.696535415Z", "2025-08-12T19:17:58.696374741Z", 23404009995f64),
            ("2025-08-12T19:17:58.696374741Z", "2025-08-12T19:17:58.699059787Z", 180f64),
            ("2025-08-12T19:17:58.699059787Z", "2025-08-12T19:18:08.703955072Z", 17285523156f64),
            ("2025-08-12T19:18:08.703955072Z", "2025-08-12T19:18:08.706654946Z", 6431618f64),
        ];

        let start_times: Vec<DateTime<Utc>> = raw_data.into_iter().map(|r| r.0.parse().unwrap()).collect();
        let timestamps: Vec<DateTime<Utc>> = raw_data.into_iter().map(|r| r.1.parse().unwrap()).collect();

        let input_points: Vec<_> = raw_data.into_iter().map(|r| Some(r.2)).collect();

        let window_start: DateTime<Utc> = "2025-08-12T19:17:00.0Z".parse().unwrap();
        let window_end: DateTime<Utc> = "2025-08-12T19:18:00.0Z".parse().unwrap();
