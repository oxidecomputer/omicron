...
use tufaceous_artifact::installinator::InstallinatorArtifactId;
use update_engine::{
...
impl<'a> ArtifactWriter<'a> {
    pub(crate) fn new(
        ...
        host_phase_2_id: &'a InstallinatorArtifactId,
...
pub(crate) struct ZoneToWrite {
    pub(crate) id: InstallinatorArtifactId,
    ...
    fn register_steps<'b>(
        ...
        transport = engine
            .new_step(
                ...
                async move |cx| {
                    let transport = transport.into_value(cx.token()).await;
                    let measurement_manifest_json =
                        self.omicron_measurement_manifest_artifact().await;
...
mod tests {
    ...
    use tufaceous_artifact::installinator::InstallinatorArtifactKind;
    ...
    async fn proptest_write_artifact_impl(
        ...
        let host_id = InstallinatorArtifactId {
            kind: InstallinatorArtifactKind::HostPhase2.to_id(),
            hash: {
        ...
        // images.
        let zone_id = dummy_artifact_hash_id(InstallinatorArtifactKind::Zone {
