...
WHERE
    time_deleted IS NULL;
/*
CREATE UNIQUE INDEX IF NOT EXISTS lookup_subnet_pool_member_by_first_address
ON omicron.public.subnet_pool_member (first_address)
WHERE
    time_deleted IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS lookup_subnet_pool_member_by_last_address
ON omicron.public.subnet_pool_member (last_address)
WHERE
    time_deleted IS NULL;
*/
...
WHERE
    time_deleted IS NULL;
/*
CREATE UNIQUE INDEX IF NOT EXISTS lookup_external_subnet_by_first_address
ON omicron.public.external_subnet (first_address)
WHERE
    time_deleted IS NULL;
CREATE UNIQUE INDEX IF NOT EXISTS lookup_external_subnet_by_last_address
ON omicron.public.external_subnet (last_address)
WHERE
    time_deleted IS NULL;
*/
