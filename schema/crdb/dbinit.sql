...
CREATE TABLE IF NOT EXISTS omicron.public.ip_pool (
     ...
     *
     * Note: this column existed prior to adding the multicast pool fields
     * below. To preserve column order equivalence between dbinit and the sum
     * of migrations, keep rcgen before any newly added columns. New columns
     * must be appended to the end of the table. */
    rcgen INT8 NOT NULL,

    /* Pool type for unicast vs multicast pools */
